...
// TODO: Make it all valid: https://jsdoc.app/about-getting-started.html
...
/**
* Sets the color of the row based on the 12th child. When the 12th child contains my name "Cardosi, Alexander", the color will be marked green.
...
* descriptions array of descriptions (strings)
* rows HTML element of the rows
* @throws new error if the length of descriptions does not match that of rows
*/
...
* description string
* @return line containing device name, or null if not found
*/
...
* description string
* @return line containing user name, or null if not found
*/
...
* string string that the regex will match on
* regex pattern that you want to test for
* @return line containing regex, or null if not found
*/
